...
const Contact = () => {
    ...
    useEffect(() => {
        ...
        // Cleanup
        return () => {
            document.querySelector('#canvas-container').removeChild(renderer.domElement)
        }
    }, [])
    ...
    const handleInputChange = (e) => {
        ...
        console.log('Updated Form Data:', name, value); // Debug log
    };
            ...
            case 1:
                return (
                    <div className="space-y-8 text-center relative z-10">
                        <h3 className="text-6xl md:text-5xl sm:text-4xl font-bold mb-12 text-white tracking-wider px-4">WHAT TYPE OF PROJECT?</h3>
                ...
                return (
                    <div className="space-y-8 max-w-4xl mx-auto w-full relative z-10 px-4">
                        <div className="flex items-center justify-center relative w-full">
                            ...
                            <h3 className="text-6xl md:text-5xl sm:text-4xl font-bold text-white text-center">READY TO CREATE MAGIC?</h3>
                        </div>
                        <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-6">
                            <input
                                ...
                                required
                                className="bg-transparent border-b border-gray-600 p-2 text-white focus:border-red-500 focus:outline-none"
                            />
                            <input
                                type="text"
                                name="lastName"
                            ...
                            <textarea
                                ...
                                className="col-span-2 bg-transparent border-b border-gray-600 p-2 text-white focus:border-red-500 focus:outline-none h-32"
                            />
                            <div className="col-span-2 flex justify-end">
                                <button
                                    type="submit"
                                    className="bg-red-500 text-white rounded-full w-32 h-32 hover:bg-red-600 transition-colors flex items-center justify-center font-semibold cursor-pointer"
                                >
                                    SUBMIT
                                </button>
                            </div>
